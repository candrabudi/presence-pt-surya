    ...
    <nav class="navbar py-4">
        <div class="container-xxl">
            ...
            <div class="h-right d-flex align-items-center me-5 me-lg-0 order-1">
                <div class="dropdown user-profile ms-2 ms-sm-3 d-flex align-items-center">
                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown"
                        data-bs-display="static">
                        <img class="avatar lg rounded-circle img-thumbnail"
                            src="https://cdn-icons-png.flaticon.com/128/847/847969.png" alt="profile">
                    </a>
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="flex-fill ms-3">
                                        ...
                                        <small
                                            class="">{{ Auth::user()->role == 'admin' ? 'Admin' : 'Karyawan' }}</small>
                                    </div>
                                </div>
                            ...
                            <div class="list-group m-2 ">
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-0"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                        ...
                                        <path d="M20,4c0-1.104-0.896-2-2-2H6C4.896,2,4,2.896,4,4v16c0,1.104,0.896,2,2,2h12
            c1.104,0,2-0.896,2-2V4z" style="fill:var(--primary-color);"></path>
                                        <path d="M15,6.81v2.56c0.62,0.7,1,1.62,1,2.63c0,2.21-1.79,4-4,4s-4-1.79-4-4c0-1.01,0.38-1.93,1-2.63V6.81
            C7.21,7.84,6,9.78,6,12c0,3.31,2.69,6,6,6c3.31,0,6-2.69,6-6C18,9.78,16.79,7.84,15,6.81z M13,6.09C12.68,6.03,12.34,6,12,6
            s-0.68,0.03-1,0.09V12h2V6.09z">
                                        </path>
                                    </svg>
                                    Keluar
                                </a>
